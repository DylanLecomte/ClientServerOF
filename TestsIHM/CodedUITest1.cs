...
namespace TestsIHM
{
    ...
    public class CodedUITest1
    {
        ...
        {
            // Test fonctionnel de connexion
            this.UIMap.ConnexionTest();

            // Test fonctionnel de pari du client
            this.UIMap.Bet();

            // Test fonctionnel d'ajout d'argent du client
            this.UIMap.AddMoneyTest();
        }
